...
class ChatGPTService:
    ...
    def generate_response(self, prompt: str, semantic_result: list, model: str = "gpt-4o-mini", max_tokens: int = 500) -> str:
        headers = {
            "Authorization": f"Bearer {self.api_key}",
            "Content-Type": "application/json"
        }
        
        # Extract descriptions from the semantic_result (assumed to be the FAISS search results)
        descriptions = [item[0] for item in semantic_result]
